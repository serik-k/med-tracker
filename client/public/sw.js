const CACHE_NAME = 'medtracker-shell-v4';
const SHELL = ['/', '/offline.html', '/favicon.svg', '/app-icon.svg', '/app-icon-192.png', '/app-icon-512.png', '/app-icon-maskable-512.png', '/manifest.webmanifest'];
